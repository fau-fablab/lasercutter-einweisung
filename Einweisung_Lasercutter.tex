...
\subsection{Fokus-Abstand ändern (sollte nie nötig sein)}
	...
	\begin{enumerate}
		...
		platzieren - ist zur Orientierung und wird später wieder gelöscht.
		...
		es sei denn es ist ausreichend Platz links/rechts von der Gravur da.



		\item jetzt Drucken - damit ist die Datei im Laser und startet
		...
		\item Mit Richtungstasten in X verfahren und Rotation
		verfahren bis die gewünschte Position zur Mittigen Ausgabe erreicht ist.
