...
\subsection{Prüfen der Achsen nach (vermutlicher) Kollision} \label{sec:wartung-ltt:kollision}
	\begin{itemize}
		...
		Ist die Abweichung 1\,mm oder weniger? Dann bist du hier fertig und darfst den Laser wieder in Betrieb nehmen. Ansonsten geht es weiter mit dem nächsten Abschnitt.
	\end{itemize}
