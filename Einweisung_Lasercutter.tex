...
\begin{document}
	...
	\begin{itemize}
		...
		\itemCheck Schelllack (Nur nach Rücksprache mit Betreuer! Verwechslungsgefahr: Normale Schallplatten sind \textbf{nicht} aus Schelllack sondern aus PVC und deshalb \textbf{verboten}! Das Material muss zweifelsfrei nachgewiesen sein.)
	\end{itemize}
