...
\begin{document}
	...
	Drucken kann man nur aus Adobe Reader 9 (Datei vorher nach PDF exportieren, geht gut für Inkscape) und Corel Draw (Import anderer Formate funktioniert nicht gescheit).  Das direkte Drucken aus anderen Programmen heraus, z.B. Inkscape, ist nicht möglich!
	...
	\begin{itemize}
		...
		\item Illustrator: Gruppen mit Zuschneidepfad machen oft Probleme; diese auflösen. Achte auf deinen Farbmodus! Farbmodus auf Datei $\rightarrow$ Farbmodus $\rightarrow$ RGB
		\item Richtiges Programm verwendet? Siehe Abschnitt \ref{ArbeitsablaufFlowchart} Arbeitsablauf
		\item Corel: Fufablab08 Nutzer hat auf ws11 passende Standartwerte konfiguriert. \\Defaultwerte: Lineal y-Richtung: 600mm, RGB, Dokumentengröße: 1000mm x 600mm
